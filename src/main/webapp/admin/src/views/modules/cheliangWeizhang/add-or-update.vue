    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="cheliangId" name="cheliangId" type="hidden">
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="违章编号" prop="cheliangWeizhangUuidNumber">
                       <el-input v-model="ruleForm.cheliangWeizhangUuidNumber"
                                 placeholder="违章编号" clearable  :readonly="ro.cheliangWeizhangUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="违章编号" prop="cheliangWeizhangUuidNumber">
                           <el-input v-model="ruleForm.cheliangWeizhangUuidNumber"
                                     placeholder="违章编号" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="违章名称" prop="cheliangWeizhangName">
                       <el-input v-model="ruleForm.cheliangWeizhangName"
                                 placeholder="违章名称" clearable  :readonly="ro.cheliangWeizhangName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="违章名称" prop="cheliangWeizhangName">
                           <el-input v-model="ruleForm.cheliangWeizhangName"
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.cheliangWeizhangFile" label="违章相关文件" prop="cheliangWeizhangFile">
                        <file-upload
                                tip="点击上传违章相关文件"
                                action="file/upload"
                                :limit="3"
                                :multiple="true"
                                :fileUrls="ruleForm.cheliangWeizhangFile?ruleForm.cheliangWeizhangFile:''"
                                @change="cheliangWeizhangFileUploadChange"
                        ></file-upload>
                    </el-form-item>
                    <div v-else>
                        <el-form-item v-if="ruleForm.cheliangWeizhangFile" label="违章相关文件" prop="cheliangWeizhangFile">
                            <a type="text" style="text-decoration:none" class="el-button" :href="ruleForm.cheliangWeizhangFile"  >违章相关文件下载</a>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="违章详情" prop="cheliangWeizhangContent">
                    ...
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangWeizhangContent" label="违章详情" prop="cheliangWeizhangContent">
                            <span v-html="ruleForm.cheliangWeizhangContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="发生违章时间" prop="cheliangWeizhangTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.cheliangWeizhangTime"
                                type="datetime"
                                placeholder="发生违章时间"
                                :disabled="ro.cheliangWeizhangTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangWeizhangTime" label="发生违章时间" prop="cheliangWeizhangTime">
                            <span v-html="ruleForm.cheliangWeizhangTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info'"  class="input" label="处理时间" prop="cheliangWeizhangChuliTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.cheliangWeizhangChuliTime"
                                type="datetime"
                                placeholder="处理时间"
                                :disabled="ro.cheliangWeizhangChuliTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangWeizhangChuliTime" label="处理时间" prop="cheliangWeizhangChuliTime">
                            <span v-html="ruleForm.cheliangWeizhangChuliTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="处理结果" prop="cheliangWeizhangChulijieguoContent">
                        <editor style="min-width: 200px; max-width: 600px;"
                                v-model="ruleForm.cheliangWeizhangChulijieguoContent"
                                class="editor"
                                action="file/upload">
                        </editor>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.cheliangWeizhangChulijieguoContent" label="处理结果" prop="cheliangWeizhangChulijieguoContent">
                            <span v-html="ruleForm.cheliangWeizhangChulijieguoContent"></span>
                        </el-form-item>
                    </div>
                </el-col>
            </el-row>
...
<script>
    ...
    export default {
        data() {
            return {
                ...
                ro:{
                    ...
                    cheliangWeizhangFile: false,
                    cheliangWeizhangContent: false,
                    cheliangWeizhangTime: false,
                    cheliangWeizhangChuliTime: false,
                    cheliangWeizhangTypes: false,
                    cheliangWeizhangChulijieguoContent: false,
                    insertTime: false,
                },
                ruleForm: {
                    cheliangId: '',
                    ...
                    cheliangWeizhangFile: '',
                    cheliangWeizhangContent: '',
                    cheliangWeizhangTime: '',
                    cheliangWeizhangChuliTime: '',
                    cheliangWeizhangTypes: '',
                    cheliangWeizhangChulijieguoContent: '',
                    insertTime: '',
                },
                ...
                rules: {
                   ...
                   cheliangWeizhangUuidNumber: [
                              { required: true, message: '违章编号不能为空', trigger: 'blur' },
                          ],
                   cheliangWeizhangName: [
                              { required: true, message: '违章名称不能为空', trigger: 'blur' },
                          ],
                   cheliangWeizhangFile: [
                              { required: true, message: '违章相关文件不能为空', trigger: 'blur' },
                          ],
                   cheliangWeizhangContent: [
                              { required: true, message: '违章详情不能为空', trigger: 'blur' },
                          ],
                   cheliangWeizhangTime: [
                              { required: true, message: '发生违章时间不能为空', trigger: 'blur' },
                          ],
                   cheliangWeizhangChuliTime: [
        ...
        methods: {
            ...
            //图片
            cheliangWeizhangFileUploadChange(fileUrls){
                this.ruleForm.cheliangWeizhangFile = fileUrls;
                this.addEditUploadStyleChange()
            },
