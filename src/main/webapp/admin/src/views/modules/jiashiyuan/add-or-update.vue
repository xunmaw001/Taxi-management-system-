               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="jiashiyuanEmail">
                       <el-input v-model="ruleForm.jiashiyuanEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.jiashiyuanEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现住址" prop="jiashiyuanAddress">
                       <el-input v-model="ruleForm.jiashiyuanAddress"
                                 placeholder="现住址" clearable  :readonly="ro.jiashiyuanAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="户籍地址" prop="jiashiyuanHujiAddress">
                       <el-input v-model="ruleForm.jiashiyuanHujiAddress"
                                 placeholder="户籍地址" clearable  :readonly="ro.jiashiyuanHujiAddress"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    ...
                    sexTypes: false,
                    jiashiyuanFuwuzigezhengPhoto: false,
                    jiashiyuanEmail: false,
                    jiashiyuanAddress: false,
                    jiashiyuanHujiAddress: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    ...
                    jiashiyuanJialing: '',
                    sexTypes: '',
                    jiashiyuanFuwuzigezhengPhoto: '',
                    jiashiyuanEmail: '',
                    jiashiyuanAddress: '',
                    jiashiyuanHujiAddress: '',
                },
                sexTypesOptions : [],
                rules: {
                   username: [
                   ...
                   jiashiyuanPhoto: [
                              { required: true, message: '驾驶员头像不能为空', trigger: 'blur' },
                          ],
                   age: [
                   ...
                   jiashiyuanFuwuzigezhengPhoto: [
                              { required: true, message: '服务资格证照片不能为空', trigger: 'blur' },
                          ],
                   jiashiyuanEmail: [
