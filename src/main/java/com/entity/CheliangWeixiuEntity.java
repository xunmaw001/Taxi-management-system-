...
public class CheliangWeixiuEntity<T> implements Serializable {
    ...
    public String toString() {
        return "CheliangWeixiu{" +
            "id=" + id +
            ", cheliangId=" + cheliangId +
            ", cheliangWeixiuUuidNumber=" + cheliangWeixiuUuidNumber +
            ", cheliangWeixiuName=" + cheliangWeixiuName +
            ", cheliangWeixiuFile=" + cheliangWeixiuFile +
            ", cheliangWeixiuTime=" + cheliangWeixiuTime +
            ", cheliangWeixiuContent=" + cheliangWeixiuContent +
            ", cheliangWeixiuTypes=" + cheliangWeixiuTypes +
