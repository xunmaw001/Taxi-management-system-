...
public class CheliangShiguView extends CheliangShiguEntity implements Serializable {
    private static final long serialVersionUID = 1L;

		/**
		* 保险的值
		*/
		private String cheliangShiguBaoxianValue;
		/**
		* 责任方的值
		*/
		private String cheliangShiguZerenValue;
	...
	public CheliangShiguView() {

	}

	public CheliangShiguView(CheliangShiguEntity cheliangShiguEntity) {
		try {
			BeanUtils.copyProperties(this, cheliangShiguEntity);
			...
			* 获取： 保险的值
			*/
			public String getCheliangShiguBaoxianValue() {
				return cheliangShiguBaoxianValue;
			}
			/**
			* 设置： 保险的值
			*/
			public void setCheliangShiguBaoxianValue(String cheliangShiguBaoxianValue) {
				this.cheliangShiguBaoxianValue = cheliangShiguBaoxianValue;
			}
			/**
			* 获取： 责任方的值
			*/
			public String getCheliangShiguZerenValue() {
				return cheliangShiguZerenValue;
			}
			/**
			* 设置： 责任方的值
			*/
			public void setCheliangShiguZerenValue(String cheliangShiguZerenValue) {
				this.cheliangShiguZerenValue = cheliangShiguZerenValue;
			}
